...
StatsDClient.prototype.getChildClient = function getChildClient(extraPrefix) {
    return new StatsDClient(Object.assign(this.options, {
...
StatsDClient.prototype.send = function send(name, formattedValue, tags) {
    ...
    if (this.options.libratoTags) {
        this._socket.send(prefixedName + this.formatLibratoTags(tags) + ":" + formattedValue);
    } else {
...
/*
 * formatLibratoTags(tags)
 */
StatsDClient.prototype.formatLibratoTags = function formatLibratoTags(metric_tags) {
    var tags = {};
