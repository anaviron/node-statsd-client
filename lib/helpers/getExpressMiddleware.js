...
function factory(parentClient) {
    return function (prefix, options) {
        ...
        var defaultTags = options.tags || undefined;
        ...
        return function (req, res, next) {
            ...
            res.end = function () {
                ...
                client.increment('response_code.' + res.statusCode, 1, defaultTags);
                client.timing('response_time' + urlPrefix, startTime, defaultTags);
